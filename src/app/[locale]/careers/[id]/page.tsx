                                        ...
                                        <CardContent className="p-6">
                                            ...
                                            <div className="flex gap-2">
                                                <a
                                                    ...
                                                    className="flex-1"
                                                >
                                                    <Button variant="outline" size="sm" className="w-full bg-[#0A66C2] hover:bg-[#004182] text-white border-0">
                                                ...
                                                <a
                                                    ...
                                                    className="flex-1"
                                                >
                                                    <Button variant="outline" size="sm" className="w-full bg-black hover:bg-gray-800 text-white border-0">
                                                        <svg className="h-4 w-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
