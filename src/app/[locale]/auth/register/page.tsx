...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (!response.ok) {
                setErrors({ general: data.error || t('register.registrationError') })
                return
            }
            ...
            setErrors({ general: t('register.registrationError') })
        } finally {
            setIsLoading(false)
        }
    }
    ...
    const handleOAuthLogin = async (provider: 'google' | 'github' | 'azure-ad') => {
        ...
        try {
            ...
            setErrors({ general: t('register.errors.providerError', { provider }) })
            setIsLoading(false)
        }
    }
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                        ...
                        <div className="relative my-6">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-4 bg-white text-gray-400">{t('register.or')}</span>
                            </div>
                        </div>
                        ...
                        {errors.general && (
                            <div className="mb-4 p-4 bg-gradient-to-r from-red-50 to-pink-50 border border-red-200 rounded-xl flex items-start gap-3 animate-in slide-in-from-top-2 duration-300">
                                ...
                                <div className="flex-1">
                                    <p className="text-red-700 font-medium text-sm">{t('register.errors.generic')}</p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div>
                                <Label htmlFor="name" className="text-gray-700 font-medium">{t('register.name')}</Label>
                            ...
                            <div>
                                <Label htmlFor="email" className="text-gray-700 font-medium">{t('register.email')}</Label>
                                <div className="relative mt-1">
                            ...
                            <div>
                                <Label htmlFor="password" className="text-gray-700 font-medium">{t('register.password')}</Label>
                                <div className="relative mt-1">
