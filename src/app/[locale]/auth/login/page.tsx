...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (result?.error) {
                setErrors({ general: 'E-posta veya şifre hatalı. Lütfen kontrol edip tekrar deneyin.' })
            } else {
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 via-blue-600 to-cyan-500 p-12 flex-col justify-between relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-blue-100 text-lg mb-8">
                        AI chatbot'larınızı yönetmeye devam edin.
                    </p>

                    <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                        <div className="flex items-center gap-3 mb-4">
                            <Sparkles className="h-5 w-5 text-yellow-300" />
                            <span className="text-white font-semibold">Yenilikler</span>
                        </div>
                        <ul className="space-y-2 text-blue-100 text-sm">
                            <li>✨ Gelişmiş AI yanıt kalitesi</li>
                            <li>📊 Yeni analytics dashboard</li>
                            <li>🎨 Widget özelleştirme seçenekleri</li>
                        </ul>
                    </div>
                </div>
