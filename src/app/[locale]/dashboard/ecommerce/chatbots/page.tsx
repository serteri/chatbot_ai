...
import {
    ShoppingBag, // E-ticaret için özel ikon
    MessageSquare,
    FileText,
    ArrowLeft,
    Plus,
...
export default async function EcommerceChatbotsPage(props: {
    ...
    // E-ticaret sektörü için filtreleme
    const whereCondition: any = {
        userId: session.user.id,
        industry: 'ecommerce', // Sadece e-ticaret chatbotları
        name: {
            contains: query,
            mode: 'insensitive'
        }
                    ...
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center gap-3">
                            <CreateChatbotDialog
                                ...
                                trigger={
                                    <Button className="bg-purple-600 hover:bg-purple-700 shadow-sm text-white transition-all hover:scale-105">
                            ...
                            <Card key={chatbot.id} className="group hover:shadow-lg transition-all duration-200 border-slate-200 bg-white flex flex-col overflow-hidden">
                                <CardHeader className="pb-4 space-y-0 border-b border-slate-50 bg-slate-50/30">
                                    <div className="flex items-start justify-between">
                                        <div className="flex gap-3">
                                            <div className="h-12 w-12 rounded-xl flex items-center justify-center shadow-sm flex-shrink-0 text-white bg-purple-600">
                                                <ShoppingBag className="h-6 w-6" />
                                            </div>
                                            <div>
                                ...
                                <CardContent className="flex-1 flex flex-col pt-4">
                                    ...
                                    <div className="mt-auto flex gap-2">
                                        ...
                                        <Link href={`/${locale}/widget-test?chatbotId=${chatbot.identifier}&mode=ecommerce`} target="_blank" className="flex-1">
