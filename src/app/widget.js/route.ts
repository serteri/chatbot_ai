...
(function() {
    ...
    // Add pulsing effect specifically for this button color
    var pulseColor = buttonColor;
    // Simple logic to make pulse color slightly transparent
    if (pulseColor.startsWith('#')) {
        // Very basic hex to rgb for opacity - just utilizing the button color for shadow
        // We'll trust the main customized color for the shadow base
    }
