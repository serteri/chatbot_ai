...
export function HeroEnterprise({ locale }: { locale: string }) {
    ...
    return (
        <section className="relative overflow-hidden bg-slate-900 pt-32 pb-20 lg:pt-40 lg:pb-28">
            ...
            <div className="absolute top-0 right-0 -translate-y-12 translate-x-1/3 w-[800px] h-[600px] bg-teal-500/20 rounded-full blur-[120px] pointer-events-none" />
            <div className="absolute bottom-0 left-0 translate-y-1/3 -translate-x-1/4 w-[600px] h-[500px] bg-emerald-500/10 rounded-full blur-[100px] pointer-events-none" />
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                >
                    <Link
                        ...
                        className="w-full sm:w-auto px-8 py-4 bg-teal-600 hover:bg-teal-500 text-white rounded-xl font-bold transition-all flex items-center justify-center gap-2 group"
                    >
